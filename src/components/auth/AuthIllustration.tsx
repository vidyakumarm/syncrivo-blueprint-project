                ...
                <div className={`relative w-[280px] h-[280px] transition-all duration-700 ${isVisible ? "opacity-100 scale-100" : "opacity-0 scale-90"}`}>
                    ...
                    <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 z-20">
                        <div className="relative w-24 h-24 flex items-center justify-center">
                            ...
                            {/* Inner glass core */}
                            <div className="relative w-full h-full rounded-full bg-gradient-to-br from-white/90 to-white/50 dark:from-slate-900/90 dark:to-slate-800/50 backdrop-blur-xl border border-white/40 dark:border-slate-700/50 shadow-xl flex flex-col items-center justify-center z-10">
