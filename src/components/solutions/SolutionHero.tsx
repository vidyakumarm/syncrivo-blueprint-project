...
export function SolutionHero({ badge, headline, subheadline, primaryPlatform = 'teams', heroImage }: SolutionHeroProps) {
      ...
      <section className="relative min-h-[calc(100vh-120px)] flex items-center py-16 md:py-20 lg:py-24 overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            >
              {heroImage ? (
                <div className="relative rounded-2xl overflow-hidden shadow-2xl border border-border/10 bg-card/10 backdrop-blur-sm max-w-[600px]">
                  <img src={heroImage} alt={badge} className="w-full h-auto object-cover" />
