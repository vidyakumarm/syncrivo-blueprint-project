...
const Security = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEO
        title="Enterprise Security & Compliance | SyncRivo"
        description="SyncRivo adheres to SOC2, GDPR, and ISO 27001 standards. Learn about our end-to-end encryption, access controls, and data privacy policies."
      />
      <Navigation />
